...
(function() {
  ...
  function initHeader() {
    ...
    // get height of large-header that is set in html
    ...
    // create points
    var divisor=10;
    var widthDivisor = $('#large-header').width() / 100;
    //var heightDivisor = $('#large-header').height() / 100;
    if(width >= 800) {
        var heightDivisor = 20;
    } else {
        var heightDivisor = 10;
    }
    points = [];
    for(var x = 0; x < width; x = x + width / widthDivisor) {
      for(var y = 0; y < height; y = y + height / heightDivisor) {
        var px = x + Math.random()*width / widthDivisor;
        var py = y + Math.random()*height / heightDivisor;
